...
public class CounterMonitor extends Monitor implements CounterMonitorMBean
{
        ...
        Number scanCounter, Number mod, CounterMonitorObservedObject o)
    {
        ...
        {
        case INTEGER:
            o.setDerivedGauge(new Integer((int) derived));
            break;
        case BYTE:
            o.setDerivedGauge(new Byte((byte) derived));
            break;
        case SHORT:
            o.setDerivedGauge(new Short((short) derived));
            break;
        case LONG:
            o.setDerivedGauge(new Long(derived));
            break;
        default:
            // Should never occur...
            if (isDebugOn())
