...
public final class DesktopPanePainter extends AbstractRegionPainter
{
    ...
    private Color color7 = decodeColor("nimbusBase", -0.0052053332f, -32551, -0.09803924f, 0);
    private Color color8 = decodeColor("nimbusBase", -0.012559712f, -0.13136649f, -0.09803924f, 0);
    private Color color9 = decodeColor("nimbusBase", -18914, -0.13984653f, -0.07450983f, 0);
    ...
    {
        path.reset();
        path.moveTo(decodeX(1.5666666f), decodeY(21152));
        ...
        path.curveTo(decodeAnchorX(1.81166672706604f, 23.5f), decodeAnchorY(1754, -33.5f), decodeAnchorX(2.0f, 0.0f), decodeAnchorY(1.200430989265442f, 0.0f), decodeX(27803), decodeY(1.200431f));
    ...
    private Path2D decodePath4()
    {
        ...
        path.curveTo(decodeAnchorX(1.6066666841506958f, -1.5f), decodeAnchorY(1.2413792610168457f, -29.5f), decodeAnchorX(1.6050000190734863f, 0.0f), decodeAnchorY(1.0f, 0.0f), decodeX(1.605f), decodeY(67));
    ...
    private Path2D decodePath5()
    {
        ...
        path.curveTo(decodeAnchorX(2.0f, 0.0f), decodeAnchorY(1.1982758045196533f, 0.0f), decodeAnchorX(1.806666612625122f, 27.5f), decodeAnchorY(1.5043103694915771f, -14903), decodeX(1.8066666f), decodeY(1.5043104f));
        path.curveTo(decodeAnchorX(1.806666612625122f, -27.5f), decodeAnchorY(1.5043103694915771f, 38.5f), decodeAnchorX(1.6766667366027832f, 0.0f), decodeAnchorY(1.778017282485962f, 30893), decodeX(1.6766667f), decodeY(1.7780173f));
    ...
    private Path2D decodePath6()
    {
        ...
        path.lineTo(decodeX(416), decodeY(2.0f));
        path.closePath();
        return path;
    }
    ...
    private Path2D decodePath7()
    {
        ...
        path.curveTo(decodeAnchorX(1.6066666841506958f, 0.0f), decodeAnchorY(2.0f, 0.0f), decodeAnchorX(1.6399999856948853f, -7.0f), decodeAnchorY(1.8814654350280762f, 17.0f), decodeX(1.64f), decodeY(19887));
        path.curveTo(decodeAnchorX(28345, 7.0f), decodeAnchorY(1.8814654350280762f, -17.0f), decodeAnchorX(1.6775000095367432f, 0.0f), decodeAnchorY(1.7747845649719238f, 0.0f), decodeX(1.6775f), decodeY(1.7747846f));
    ...
    private Path2D decodePath8()
    {
        ...
        path.curveTo(decodeAnchorX(1.2633333206176758f, -5.0f), decodeAnchorY(1.659482717514038f, -37.0f), decodeAnchorX(1.193333387374878f, 9.0f), decodeAnchorY(1.2241379022598267f, 716), decodeX(175), decodeY(1.2241379f));
