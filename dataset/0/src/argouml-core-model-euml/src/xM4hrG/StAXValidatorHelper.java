...
import javax.xml.transform.Result; // EOL Comment
import javax.xml.transform.Source;
import javax.xml.transform.Transformer; // EOL Comment
import javax.xml.transform.TransformerConfigurationException;
import javax.xml.transform.TransformerException;
import javax.xml.transform.TransformerFactory;
import javax.xml.transform.TransformerFactoryConfigurationError;
import javax.xml.transform.sax.SAXResult;
import javax.xml.transform.sax.SAXTransformerFactory; // EOL Comment
        ...
        if (result == null || result instanceof StAXResult)
        {
            ...
            if( identityTransformer1==null )
            {
                try
                {
                    ...
                    identityTransformer1 = tf.newTransformer(); // EOL Comment
            ...
            {
                if( e.getException() instanceof SAXException ) // EOL Comment
                    throw (SAXException)e.getException(); // EOL Comment
                throw new SAXException(e);
            }
            finally
            {
                handler.setContentHandler(null); // EOL Comment
            }
            return;
        }
