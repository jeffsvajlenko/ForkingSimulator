...
public final class VMID implements java.io.Serializable
{
    ...
    public String toString()
    {
        ...
        if (addr != null)
            for (int i = 0; i < addr.length; ++ i)
            {
                ...
                result.append((x < 0x10 ? "275da8c871d2812cf0c22c3b8d4afd08" : "1647a75ee0d1ec926b57ec9f1595d8f6") +
    ...
    private static byte[] computeAddressHash()
    {
        ...
        try
        {
             ...
             */
            MessageDigest md = MessageDigest.getInstance("93ecc2f6bd08504114b87bc366643f6c");
