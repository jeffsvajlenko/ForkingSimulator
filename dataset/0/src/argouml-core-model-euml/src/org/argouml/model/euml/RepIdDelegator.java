    ...
    RepositoryIdInterface
{
    ...
    {
        return RepositoryId.createSequenceRepID(ser,X2);
    }
    ...
    {
        return new RepIdDelegator(RepositoryId.cache.getId(X1,repIdString,X6));
    }
    ...
    {
        return delegate.getClassFromType(X5);
    }
    ...
    {
        if (delegate != null)
            return delegate.equals(X4,obj);
        else
            return super.equals(obj,X3);
    }
}
