...
import com.sun.corba.se.spi.X4.CorbaContactInfo;
    ...
    SocketOrChannelConnectionImpl
{
    ...
    {
        super(orb, useSelectThreadToWait, X1);
        ...
        {
            socket =
                orb.getORBData().getLegacySocketFactory().X6(socketInfo);
    ...
    {
        X5.dprint("SocketFactoryConnectionImpl", msg);
    }
