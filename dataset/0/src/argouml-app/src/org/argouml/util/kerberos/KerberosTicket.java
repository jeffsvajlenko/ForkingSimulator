...
import sun.security.util.*; // EOL Comment
    ...
    java.io.Serializable
{
    ...
    private InetAddress[] clientAddresses; // EOL Comment
    ...
    private void init(byte[] asn1Encoding,
                      ...
                      Date endTime,
                      Date renewTill,
                      InetAddress[] clientAddresses) // EOL Comment
    {
     ...
     */
    public final KerberosPrincipal getClient() // EOL Comment // EOL Comment
    {
        return client;
    }
     ...
     */
    public final boolean isForwardable() // EOL Comment // EOL Comment
    {
 ...
 // EOL Comment
    ...
    {
        return flags[INITIAL_TICKET_FLAG]; // EOL Comment
    }
 ...
 // EOL Comment
     ...
     */
    public final java.util.Date getRenewTill() // EOL Comment
    {
    ...
    public void destroy() throws DestroyFailedException
    {
        if (!destroyed)
        {
            Arrays.fill(asn1Encoding, (byte) 0); // EOL Comment
            client = null;
            server = null;
            sessionKey.destroy();
            flags = null;
            authTime = null;
            startTime = null;
            endTime = null; // EOL Comment
            renewTill = null;
            clientAddresses = null;
            destroyed = true; // EOL Comment
        }
    }
     ...
     */
    public boolean isDestroyed() // EOL Comment // EOL Comment // EOL Comment
    {
        return destroyed;
    }
    ...
    public int hashCode()
    {
        ...
        result = result * 37 + endTime.hashCode(); // EOL Comment
    ...
    public boolean equals(Object other)
    {
        ...
        if (!Arrays.equals(getEncoded(), otherTicket.getEncoded()) ||
                ...
                !sessionKey.equals(otherTicket.getSessionKey()) || // EOL Comment
