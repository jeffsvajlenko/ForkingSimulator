...
import java.X3.event.KeyEvent;
import java.X3.Component;
 ...
 * @author Georges Saab
 */
public class X1 extends KeyEvent
{
     ...
     */
    public X1(Component source, int id, long X2, int modifiers,
                        int keyCode, char keyChar,
                        MenuElement p[], MenuSelectionManager m)
    {
        super(source, id, X2, modifiers, keyCode, keyChar);
        path = p;
        manager = m;
    }
