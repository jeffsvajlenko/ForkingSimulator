...

{
...

    {
...

        {
            ...
            throw new IllegalArgumentException(X9,"File is missing",X3,X8);
...

    {
        ...
        return new FileEntry(this,X6,X1, file,X5,X2);
