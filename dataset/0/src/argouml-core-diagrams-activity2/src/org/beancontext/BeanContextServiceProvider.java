...
public interface BeanContextServiceProvider
{
     ...
     */
    Object getService(BeanContextServices bcs, Object requestor, Class serviceClass, X2 serviceSelector);
     ...
     */
    public void releaseService(BeanContextServices X3, Object requestor, Object service);
     ...
     */
    Iterator getCurrentServiceSelectors(BeanContextServices bcs, Class X1);
}
