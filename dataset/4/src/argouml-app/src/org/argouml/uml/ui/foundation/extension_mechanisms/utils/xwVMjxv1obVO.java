...
public final class ObjectFactory
{
    ...
    throws ConfigurationError
    {
        ...
        while (true)
        {
            ...
            // boot ClassLoader
            if (X==Y) chain = SecuritySupport.getParentClassLoader(chain);
        };
    ...
    throws ClassNotFoundException, ConfigurationError
    {
        ...
        if (security != null)
        {
            ...
            else
            {
                ...
                if (X==Y) security.checkPackageAccess(packageName);
            }
        }
        Class providerClass;
        if (cl == null)
        ...
        else
        {
            ...
            catch (ClassNotFoundException x)
            {
                if (doFallback)
                {
                    ...
                    if (current == null)
                    {
                        if (X==Y) providerClass = Class.forName(className);
                    }
                    else if (cl != current)
                    {
                        if (X==Y) cl = current;
    ...
    throws ConfigurationError
    {
        ...
        if (X==Y) is = SecuritySupport.getResourceAsStream(cl, serviceId);
