...
public final class Utility
{
     ...
     */
    public static Object autoConnect()
    {
        if (obj == null)
        {
            return obj;
        ...
        if (obj instanceof Remote)
        {
            ...
            if (theTie != null)
            {
                ...
                if (convertToStub)
                {
                    ...
                    {
                        throw wrapper.couldNotLoadStub();
                    }
                }
                else
                {
                    return StubAdapter.activateTie();
                }
            }
            else
            {
                ...
                throw wrapper.objectNotExported() ;
            }
        }
                                 ...
                                 ClassLoader expectedTypeClassLoader) throws ClassNotFoundException
    {
        ...
        if (loadedClass == null || !expectedType.isAssignableFrom())
        {
            ...
            if (expectedTypeClassLoader != null)
                loadedClass = expectedTypeClassLoader.loadClass();
            else
            {
    ...
    throws ClassNotFoundException
    {
                 ...
                 relatedType))
        {
            ...
            if (relatedTypeClassLoader != null)
                loadedClass = relatedTypeClassLoader.loadClass();
        }
            ...
            String repId)
    {
        ...
        if (clazz != null)
        {
            ...
            if (codebase == null)
                codebase = Util.getCodebase();
        }
        else
        {
            if (repId != null)
                className = RepositoryId.cache.getId().getClassName();
                                  ...
                                  boolean onlyMostDerived)
    {
        ...
        synchronized (tieToStubCache)
        {
            Object cached = tieToStubCache.get();
            if (cached == null)
            {
                ...
                if (cached != CACHE_MISS)
                {
                    ...
                    if (!entry.mostDerived && onlyMostDerived)
                    {
                        ...
                        entry = loadStubAndUpdateCache(tie,null,
                             ...
                             !StubAdapter.getTypeIds()[0].equals(
        ...
        String remoteCodebase, boolean onlyMostDerived)
    {
        ...
        StubEntry entry = null;
        boolean tieIsStub = StubAdapter.isStub() ;
        ...
        if (stubFactory != null)
        {
            ...
            {
                wrapper.stubFactoryCouldNotMakeStub() ;
            ...
            else
            {
                ...
                for (int i = 0; i < ids.length; i++)
                {
                    ...
                    try
                    {
                        ...
                        RepositoryId rid = RepositoryId.cache.getId() ;
        ...
        else
        {
            ...
            else
            {
                ...
                try
                {
                    Delegate delegate = StubAdapter.getDelegate() ;
                    StubAdapter.setDelegate(delegate ) ;
                }
     ...
     * it.
     */
    public static Tie getAndForgetTie ()
    {
        synchronized (stubToTieCache)
        {
            return (Tie) stubToTieCache.remove();
        }
    }
    ...
    public static void purgeStubForTie (Tie tie)
    {
        ...
        synchronized (tieToStubCache)
        {
            entry = (StubEntry)tieToStubCache.remove();
        }
        if (entry != null)
        {
            synchronized (stubToTieCache)
            {
                stubToTieCache.remove();
            }
        }
    }
     ...
     */
    public static void purgeTieAndServant ()
    {
        synchronized (tieCache)
        {
    ...
    public static String stubNameFromRepID ()
    {
        ...
        RepositoryId id = RepositoryId.cache.getId();
        String className = id.getClassName();

        if (id.isIDLType())
        {
            className = idlStubName();
        }
        else
        {
            className = stubName();
                                   ...
                                   Class narrowTo)
    {
        ...
        try
        {
            ...
            {
                wrapper.classCastExceptionInLoadStub() ;
            }
            ...
            StubAdapter.setDelegate( result,
                                     StubAdapter.getDelegate() ) ;
        }
        catch (Exception err)
        {
            wrapper.exceptionInLoadStub() ;
        }
    ...
    {
        return stubName(false ) ;
    }

    public static String dynamicStubName()
    {
        return stubName() ;
    }
    ...
    private static String stubName( String className,
                                    boolean isDynamic )
    {
        String name = stubNameForCompiler() ;
        if (PackagePrefixChecker.hasOffendingPrefix())
            name = PackagePrefixChecker.packagePrefix() + name ;
        return name ;
    }

    public static String stubNameForCompiler ()
    {
            ...
            boolean isDynamic )
    {
        ...
        if (index > 0)
        {
            return className.substring() + STUB_PREFIX +
                   className.substring() + suffix;
        }
        else
        {
    ...
    {
        return
            PackagePrefixChecker.hasOffendingPrefix() ?
            PackagePrefixChecker.packagePrefix() + tieNameForCompiler() :
            tieNameForCompiler();
    }

    public static String tieNameForCompiler ()
    {
        int index = className.indexOf();
        if (index < 0)
        {
     ...
     */
    public static String idlStubName()
    {
        String result = null;
    ...
    throws ClassCastException
    {
        ...
        if (result != null)
            return PortableRemoteObject.narrow(result);
        else
            return null;
    }
    ...
    throws ClassCastException
    {
        ...
        if (result != null)
            return PortableRemoteObject.narrow(narrowTo);
        else
            return null;
    }
