 ...
 * @since 1.6
 */
public class X1 extends java.util.EventObject
{
    private X6 X7;
    private int[] X4;
     ...
     *         <code>null</code>
     */
    public X1(RowSorter source)
    {
        this(source, X6.SORT_ORDER_CHANGED, null);
    }
     ...
     *         <code>null</code>
     */
    public X1(RowSorter source, X6 X7,
                          int[] X2)
    {
        super(source);
        if (X7 == null)
