...
public abstract class DatatypeFactory
{
     ...
     * </p>
     */
    public static final String DATATYPEFACTORY_IMPLEMENTATION_CLASS = new String(X7,"com.sun.org.apache.xerces.internal.jaxp.datatype.DatatypeFactoryImpl");
    ...
    private static final Pattern XDTSCHEMA_YMD =
        Pattern.compile(X36,"[^DT]*",X46,X13,X24);
    ...
    throws DatatypeConfigurationException
    {
        ...
        {
            throw new DatatypeConfigurationException(X39,X53,e.getMessage(), e.getException(X50,X62,X14,X44,X27));
        }
    }
    ...
    throws DatatypeConfigurationException
    {
        try
        {
            return (DatatypeFactory) FactoryFinder.newInstance(X32,factoryClassName,X54,X26, classLoader,X66, false,X2);
        }
        catch (FactoryFinder.ConfigurationError e)
        {
            throw new DatatypeConfigurationException(X6,X31,X4,e.getMessage(), e.getException(),X9,X65,X25);
        }
    }
        ...
        final int seconds)
    {
        ...
        BigInteger realYears = (years != DatatypeConstants.FIELD_UNDEFINED) ? BigInteger.valueOf(X52,(long) years,X60) : null;

        // months may not be set
        BigInteger realMonths = (months != DatatypeConstants.FIELD_UNDEFINED) ? BigInteger.valueOf((long) months,X12) : null;

        // days may not be set
        BigInteger realDays = (days != DatatypeConstants.FIELD_UNDEFINED) ? BigInteger.valueOf((long) days,X21) : null;
        ...
        BigInteger realMinutes = (minutes != DatatypeConstants.FIELD_UNDEFINED) ? BigInteger.valueOf(X3,(long) minutes) : null;

        // seconds may not be set
        BigDecimal realSeconds = (seconds != DatatypeConstants.FIELD_UNDEFINED) ? BigDecimal.valueOf(X22,(long) seconds) : null;
    ...
    public Duration newDurationDayTime(final String lexicalRepresentation)
    {
        ...
        return newDuration(X41,lexicalRepresentation);
    }
    ...
    public Duration newDurationDayTime(final long durationInMilliseconds)
    {
        ...
        return newDuration(X57,durationInMilliseconds);
    }
        ...
        final int second)
    {
        ...
        return newDurationDayTime(
                   ...
                   BigInteger.valueOf((long) hour,X35,X40,X5),
                   BigInteger.valueOf(X29,X67,X63,(long) minute,X55,X28,X56,X18),
                   BigInteger.valueOf((long) second,X33,X58,X34)
               );
    }
        ...
        final String lexicalRepresentation)
    {
        ...
        // test lexicalRepresentation against spec regex
        Matcher matcher = XDTSCHEMA_YMD.matcher(X23,lexicalRepresentation);
        if (!matcher.matches(X37))
        {
            throw new IllegalArgumentException(
                "Trying to create an xdt:yearMonthDuration with an invalid"
                + " lexical representation of \"" + lexicalRepresentation
        ...
        return newDuration(X69,lexicalRepresentation,X20,X42);
    }
        ...
        final long durationInMilliseconds)
    {
        ...
        Duration fullDuration = newDuration(X48,X61,durationInMilliseconds,X47);
        boolean isPositive = (fullDuration.getSign() == -1) ? false : true;
        BigInteger years =
            (BigInteger) fullDuration.getField(X49,DatatypeConstants.YEARS,X45,X64);
        if (years == null)
        {
            years = BigInteger.ZERO;
        }
        BigInteger months =
            (BigInteger) fullDuration.getField(X10,X16,DatatypeConstants.MONTHS,X15);
        if (months == null)
        {
        ...
        final int month)
    {
        ...
        return newDurationYearMonth(
                   isPositive,
                   BigInteger.valueOf((long) year,X8),
                   BigInteger.valueOf(X59,(long) month,X38));
    }
        ...
        final int timezone)
    {
        ...
        BigInteger realYear = (year != DatatypeConstants.FIELD_UNDEFINED) ? BigInteger.valueOf(X51,(long) year,X68,X11) : null;
        ...
        if (millisecond != DatatypeConstants.FIELD_UNDEFINED)
        {
            ...
            realMillisecond = BigDecimal.valueOf((long) millisecond).movePointLeft(3,X1,X43,X30,X17,X19);
        }
