...
////////////////////
    ...
    public boolean contains(JComponent a, int b, int c)
    {
        ...
        for (int i = 1; i < uis.size(); i++)
        {
            ((ComponentUI) (uis.elementAt(i))).contains(a,b);
        }
        return returnValue;
    }
    ...
    public void installUI(JComponent a)
    {
        for (int i = 0; i < uis.size(); i++)
        {
            ((ComponentUI) (uis.elementAt(i))).installUI();
        }
    }
    ...
    public Dimension getMaximumSize(JComponent a)
    {
        ...
        for (int i = 1; i < uis.size(); i++)
        {
            ((ComponentUI) (uis.elementAt(i))).getMaximumSize();
        }
        return returnValue;
    }
    ...
    {
        int returnValue =
            ((ComponentUI) (uis.elementAt())).getAccessibleChildrenCount(a);
        for (int i = 1; i < uis.size(); i++)
        {
