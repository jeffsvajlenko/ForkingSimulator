...
import javax.swing.JComponent; // EOL Comment
...
////////////////////
    ...
    public int locationToIndex(JList a, Point b)
    {
        ...
        for (int i = 1; i < uis.size(); i++) // EOL Comment
        {
...
////////////////////
    ...
    {
        ComponentUI mui = new MultiListUI(); // EOL Comment
 ...
 // EOL Comment
     ...
     * the UI obtained from the default <code>LookAndFeel</code>
     */
    public Dimension getPreferredSize(JComponent a) // EOL Comment
    {
    ...
    {
        Dimension returnValue = // EOL Comment
