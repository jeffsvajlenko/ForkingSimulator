...
////////////////////
    ...
    public Rectangle getTabBounds(JTabbedPane a, int b)
    {
        ...
        for (int i = 1; i < uis.size(); i++)
        {
            ((TabbedPaneUI) (uis.elementAt(i))).getTabBounds /* Comment */ (a,b);
    /* Comment */      }
        return returnValue;
    }
...
////////////////////
    ...
    public boolean contains(JComponent a, int b, int c)
    {
        ...
        /* Comment */  for (int i = 1; i < uis.size(); i++)
        {
            ((ComponentUI) /* Comment */  (uis.elementAt(i))).contains(a,b,c);
        }
        return returnValue;
    }
    ...
    public void paint(Graphics a, JComponent b)
    {
        for (int i = 0; i < uis.size(); i++)
        {
            ((ComponentUI) (uis.elementAt(i))).paint(a /* Comment */ ,b);
        }
    }
  ...
  /* Comment */        }
    ...
    public Dimension getMaximumSize(JComponent a)
    {
        ...
        for (int i = 1; i < uis.size(); i /* Comment */ ++)
        {
