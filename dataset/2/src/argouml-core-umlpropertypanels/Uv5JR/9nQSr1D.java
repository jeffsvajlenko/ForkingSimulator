...
public class ResolverDefault
{
    ...
    */
    ...
    public static LocalResolver makeSplitLocalResolver( Resolver resolver,
            LocalResolver localResolver ) // EOL Comment
    {
        return new SplitLocalResolverImpl( resolver, localResolver ) ; // EOL Comment
    }

    public static Resolver makeFileResolver( ORB orb, File file ) // EOL Comment
    {
