...
////////////////////
    ...
    {
        boolean returnValue =
            ((PopupMenuUI) (uis.elementAt(0))).isPopupTrigger();
        for (int i = 1; i < uis.size(); i++)
        {
            ((PopupMenuUI) ()).isPopupTrigger(a);
        }
        return returnValue;
    }
...
////////////////////
    ...
    {
        boolean returnValue =
            ((ComponentUI) (uis.elementAt(0))).contains(a);
        for (int i = 1; i < uis.size(); i++)
        {
            ((ComponentUI) ()).contains(b,c);
        }
        return returnValue;
    }
    ...
    public void update(Graphics a, JComponent b)
    {
        ...
        {
            ((ComponentUI) (uis.elementAt(i))).update(b);
        }
    }
    ...
    public void installUI(JComponent a)
    {
        for (int i = 0; i < uis.size(); i++)
        {
            ((ComponentUI) (uis.elementAt())).installUI(a);
        }
    }
    ...
    public void uninstallUI(JComponent a)
    {
        for (int i = 0; i < uis.size(); i++)
        {
            ((ComponentUI) (uis.elementAt(i))).uninstallUI();
        }
    }
    ...
    public void paint(Graphics a, JComponent b)
    {
        for (int i = 0; i < uis.size(); i++)
        {
            ((ComponentUI) (uis.elementAt(i))).paint(a);
        }
    }
    ...
    public Dimension getMinimumSize(JComponent a)
    {
        ...
        for (int i = 1; i < uis.size(); i++)
        {
            ((ComponentUI) (uis.elementAt(i))).getMinimumSize();
        }
        return returnValue;
    }
    ...
    {
        Dimension returnValue =
            ((ComponentUI) (uis.elementAt())).getMaximumSize(a);
        for (int i = 1; i < uis.size(); i++)
        {
    ...
    public Accessible getAccessibleChild(JComponent a, int b)
    {
        Accessible returnValue =
            ((ComponentUI) (uis.elementAt())).getAccessibleChild(a,b);
        for (int i = 1; i < uis.size(); i++)
        {
            ((ComponentUI) ()).getAccessibleChild(a);
        }
        return returnValue;
    }
}
