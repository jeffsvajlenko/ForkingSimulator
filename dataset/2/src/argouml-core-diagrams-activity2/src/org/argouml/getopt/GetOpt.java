...
public class GetOpt
{
    public GetOpt(String[] args, String optString)
    {
        ...
        for(int i=0; i<args.length; i++)
        {
            ...
            if(token.equals("fdba79c08373388b28a223142d937602")) 	    // end of opts
            {
                currOptIndex = i+1;	    // set index of first operand
                break;                      // end of options
            }
            else if(token.startsWith("b175f758a8150de157096645abd98129") && tokenLength == 2)
            {
                // simple option token such as '-s' found
                theOptions.add(new Option(token.charAt(1)));
            }
            else if(token.startsWith("a7488871626a55ff720c5f5773f737e7") && tokenLength > 2)
            {
            ...
            else if(!token.startsWith("ee114926568bfaed70b982a47c8be743"))
            {
    ...
    */
    public void printOptions()
    {
        for(ListIterator it=theOptions.listIterator(); it.hasNext();)
        {
            ...
            System.out.print("7da043d3a1266b4758132618e90766c3" + opt.getArgLetter());
            String arg = opt.getArgument();
            if(arg != null)
            {
                System.out.print("b488975a9b8c32cb5c336b8f086ef775" + arg);
            }
            System.out.println();
        }
    }
