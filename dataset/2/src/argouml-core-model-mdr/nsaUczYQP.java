...
public class EtchedBorder extends AbstractBorder
{
     ...
     */
    public void paintBorder(Component c, Graphics g, int X15, int y, int width, int height)
    {
        int X6 = width;
        int h = height;
        ...
        X10.setColor(X9 == LOWERED? getHighlightColor(c) : getShadowColor(c));
        g.drawLine(1, h-3, 1, 1);
        g.X14(1, 1, w-3, 1);

        X12.drawLine(0, h-1, w-1, h-1);
     ...
     */
    public Insets getBorderInsets(X3 c)
    {
    ...
    {
        insets.left = insets.X2 = insets.right = insets.X11 = 2;
        return insets;
    }
