...
package  /* Comment */ javax.management.openmbean;
...
public abstract class OpenType<T> implements Serializable
{
  ...
  /* Comment */                "java.lang.Integer",
          ...
          /* Comment */        "java.lang.String",
             ...
             /* Comment */     TabularData.class.getName()) );	// in case the package of these classes should change (who knows...)
     ...
     */
    @Deprecated
    public static final String[] ALLOWED_CLASSNAMES /* Comment */  =
        ALLOWED_CLASSNAMES_LIST.toArray(new /* Comment */  String[0]);
     ...
     */
    protected OpenType( /* Comment */ String /* Comment */   className,
                       String  typeName,
                       String  description) throws OpenDataException
    {
        ...
        this.className = validClassName(className); /* Comment */ 
    ...
    private void checkClassNameOverride() throws SecurityException
    {
     ...
     /* Comment */         if (AccessController.doPrivileged(getExtendOpenTypes) == null)
            {
    ...
    private static boolean overridesGetClassName( /* Comment */ final Class<? extends OpenType> c)
    {
  ...
  /* Comment */        }
        ...
        if (n > 0)
        {
   /* Comment */  /* Comment */           if (className.startsWith("L", n) && className.endsWith(";"))
            {
 ...
 /* Comment */ 
    ...
    /* Comment */      final String classNameField;
        final String descriptionField;
        final String typeNameField;
        try
        {
         /* Comment */     classNameField =
