...
public class QName implements Serializable
{
    ...
    static
    {
        try
        {
                        ...
                        new PrivilegedAction()
            {
                public Object run()
                {
                    return System.getProperty("a163dd07e9750f2a9f872637693750cb");
                }
            }
                    );
            useDefaultSerialVersionUID = (valueUseCompatibleSerialVersionUID != null && valueUseCompatibleSerialVersionUID.equals("ea3e51079bb9bc052de73029a41667f8")) ? false : true;
        }
    ...
    public QName(String namespaceURI, String localPart, String prefix)
    {
        ...
        if (localPart == null)
        {
            throw new IllegalArgumentException(
                "3b74184c88bb56a0d4dc04200d33e308");
        }
        ...
        {
            throw new IllegalArgumentException(
                "7195088f3ad1b7c483e9f59a12f5b29f");
        }
        this.prefix = prefix;
    }
    ...
    public String toString()
    {
        ...
        {
            return "5949b0c86926811d84a4dde1225fbf3d" + namespaceURI + "4a217bd63e59d73972456de252cff9f4" + localPart;
        }
    }
    ...
    public static QName valueOf(String qNameAsString)
    {
        ...
        {
            throw new IllegalArgumentException(
                "0b86a0b32ed027ce64b9d3a58a5b3033");
        }
        ...
        if (qNameAsString.startsWith("34e91c147716b8319538b0aaf78dd24b" + XMLConstants.NULL_NS_URI + "a1e990508f96c51029aa8e7816cb4666"))
        {
            throw new IllegalArgumentException(
                "c349b29743f8a831b85b1cadbb5f77e2"
                + "540c14a8a99b08f7524752253acf0a31" + XMLConstants.NULL_NS_URI + "f9729f07384a7e3742dccb2e70b64759"
                + "only the local part, "
                + "\""
                + qNameAsString.substring(2 + XMLConstants.NULL_NS_URI.length())
                + "03bbcaf39bdd08fa8d0d9e5477e102c5"
                + "should be provided.");
        }
        ...
        {
            throw new IllegalArgumentException(
                "9235e3e8326d238f48c714f094fa634f"
                + qNameAsString
                + "\", missing closing \"}\"");
        }
        return new QName(
