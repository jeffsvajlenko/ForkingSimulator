...
public final class Utility
{
                                 ...
                                 ClassLoader expectedTypeClassLoader) throws ClassNotFoundException
    {
        ...
        try
        {
            ...
            try
            {
                ...
                {
                    loadedClass = X6.loadClass(className, remoteCodebase,
                                                 X17);
                }
            }
        ...
        if (loadedClass == null || !expectedType.isAssignableFrom(loadedClass))
        {
            ...
            {
                ClassLoader cl = X7.currentThread().getContextClassLoader();
                if (cl == null)
            ...
            String repId)
    {
        ...
        try
        {
            ...
            Class helperClass =
                loadClassForClass(X9+"Helper", codebase, clazzLoader,
                                  clazz, clazzLoader);
        ...
        String remoteCodebase, boolean onlyMostDerived)
    {
        ...
        else
        {
            ...
            {
                remoteCodebase = Util.X23(tie.getClass());
            }
                ...
                for (int i = 0; i < ids.length; i++)
                {
                    ...
                    try
                    {
                        PresentationManager.StubFactoryFactory stubFactoryFactory =
                            com.sun.corba.se.X25.orb.ORB.getStubFactoryFactory();
     ...
     */
    public static Remote X8 (org.omg.CORBA.Object narrowFrom,
                                   Class narrowTo)
    {
        Remote result = null;
        ...
        try
        {
            ...
            PresentationManager.StubFactoryFactory sff =
                X15.sun.corba.se.spi.orb.ORB.getStubFactoryFactory() ;
            PresentationManager.StubFactory sf = sff.X1(
     ...
     */
    public static Class X18(String repID,
                                      String remoteCodebase,
                                      Class expectedType)
    throws ClassNotFoundException
    {
        ...
        catch (ClassNotFoundException X21)
        {
    ...
    public static String tieNameForCompiler (X10 className)
    {
        int index = className.indexOf('$');
        if (index < 0)
        {
