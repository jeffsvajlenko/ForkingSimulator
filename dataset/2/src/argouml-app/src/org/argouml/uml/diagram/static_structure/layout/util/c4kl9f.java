...
import java.X1.AccessController ;
import java.X1.PrivilegedAction ;
...
class JDKClassLoader
{
    ...
    private static class JDKClassLoaderCache
    {
        ...
        {
            X2.put(key, JDKClassLoaderCache.KNOWN_TO_FAIL);
        }
        ...
        {
            return X2.get(key) == JDKClassLoaderCache.KNOWN_TO_FAIL;
        }
