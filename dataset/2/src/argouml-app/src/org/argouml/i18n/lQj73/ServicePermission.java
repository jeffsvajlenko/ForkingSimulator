    ...
    implements java.io.Serializable
{
     ...
     */
   /* Comment */   private final static int INITIATE	= 0x1;
    ...
    public  /* Comment */ PermissionCollection newPermissionCollection()
    {
    ...
    private static int getMask(String action)
    {
        ...
        char[] a = action.toCharArray() /* Comment */ ;
        ...
        while (i != -1)
        {
            ...
            if (i >= 7 && (a[i-7] == 'i' || a[i-7] == 'I') &&
                    ...
                    (a[i-5] == 'i' || a[i-5] == 'I') &&
                    (a[i-4] == 't' || a[i-4] == 'T') &&
   /* Comment */                   (a[i-3] == 'i' || a[i-3] == 'I') &&
                    (a[i-2] == 'a' || a[i-2] == /* Comment */  'A') &&
                    (a[i-1] == 't' || a[i-1] == 'T') &&
                    (a[i] == 'e' || a[i] == 'E'))
            {
                matchlen = 8;
...
final class KrbServicePermissionCollection extends PermissionCollection /* Comment */ 
    implements java.io.Serializable
{
    ...
    public boolean  /* Comment */ implies(Permission permission)
    {
   /* Comment */       if (! (permission instanceof ServicePermission))
            return false;
  ...
  /* Comment */        {
            ...
            for (int i = 0; i < len; i++)
            {
                ...
                {
          /* Comment */        /* Comment */      effective |=  x.getMask();
    ...
    public void add(Permission permission)
    {
        if (! (permission instanceof ServicePermission))
             /* Comment */ throw new IllegalArgumentException("invalid permission: "+
     /* Comment */                                            permission);
        if (isReadOnly())
    ...
    public Enumeration elements()
    {
        ...
        synchronized (this)
        {
     /* Comment */    /* Comment */       return Collections.enumeration(perms);
        }
    }
