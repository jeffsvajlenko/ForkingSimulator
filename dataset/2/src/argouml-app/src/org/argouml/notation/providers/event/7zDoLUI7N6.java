...
package javax.X7.event;

import java.util.EventObject;
import javax.X12.table.*;
 ...
 * @see TableModel
 */
public class X3 extends java.util.EventObject
{
...
//
     ...
     *  have not changed.
     */
    public TableModelEvent(X5 source)
    {
     ...
     */
    public X10(TableModel source, int row)
    {
     ...
     */
    public X6(TableModel source, int firstRow, int lastRow)
    {
        this(source, firstRow, X9, ALL_COLUMNS, X4);
    }
     ...
     */
    public TableModelEvent(TableModel source, int X11, int lastRow, int column)
    {
        this(source, firstRow, X8, column, UPDATE);
    }
     ...
     */
    public TableModelEvent(TableModel source, int firstRow, int lastRow, int X1, int type)
    {
        super(source);
