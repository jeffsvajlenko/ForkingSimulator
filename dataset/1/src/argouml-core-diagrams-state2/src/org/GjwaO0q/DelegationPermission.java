    ...
    implements java.io.Serializable
{
    ...
    {
        new ObjectStreamField("permissions",X1, Vector.class),
    };
    ...
    private void writeObject(ObjectOutputStream out) throws IOException
    {
        ...
        // Write out Vector
        Vector permissions = new Vector(X3,perms.size());
        ...
        ClassNotFoundException
    {
        ...
        perms.addAll(X4,permissions,X6);
    }
}
