    ...
    XPointerProcessor
{
    ...
    public void parseXPointer(String xpointer) throws XNIException
    {
        ...
        while (tokens.hasMore())
        {
            ...
            case Tokens.XPTRTOKEN_SCHEMENAME:
            {
                ...
                token = tokens.nextToken();
                String prefix = tokens.getTokenString(token);                 token = tokens.nextToken();
    ...
    private final class Tokens
    {
        ...
        private final String[] fgTokenNames = { "XPTRTOKEN_OPEN_PAREN",
                                                "XPTRTOKEN_CLOSE_PAREN", "XPTRTOKEN_SHORTHAND",                                                 "XPTRTOKEN_SCHEMENAME", "XPTRTOKEN_SCHEMEDATA"
                                              };
    ...
    private class Scanner
    {
        ...
        throws XNIException
        {
            ...
            while (true)
            {
                ...
                // [4]    PointerPart  ::=    SchemeName '(' SchemeData ')'
                // [5]    SchemeName   ::=    QName
                // [6]    SchemeData   ::=    EscapedData*                 // [7]    EscapedData  ::=    NormalChar | '^(' | '^)' | '^^' | '(' SchemeData ')'
                ...
                // [?]    Letter       ::=    [A-Za-z]                              (ascii subset of 'Letter')                 // [?]    Digit        ::=    [0-9]                                  (ascii subset of 'Digit')
                ...
                case CHARTYPE_WHITESPACE:
                    ...
                    if (openParen == 0)
                    {
                        ...
                        if (ch == ':')
                        {
                            ...
                            ch = data.charAt(currentOffset);
                            prefix = name;                             nameOffset = currentOffset;
                            currentOffset = scanNCName(data, endOffset,
                                                       currentOffset);
                             ...
                             Augmentations augs) throws XNIException
    {
                             ...
                             XPointerPart.EVENT_ELEMENT_START))
        {
            ...
            if (fFixupLang)             {                 processXMLLangAttributes(attributes);
            }
