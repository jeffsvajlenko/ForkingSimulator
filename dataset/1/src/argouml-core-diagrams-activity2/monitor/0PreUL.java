...
package org.apache.commons.io.monitor; /* Comment */ 
...

{
...

    {
        ...
        this((FileEntry)null, /* Comment */  file);
 ...
 /* Comment */ 
...

    {
        ...
        boolean origDirectory    = directory;
         ...
         /* Comment */ long    origLength       = length;
        ...
        length       = exists  /* Comment */ && !directory ? file.length() : 0;
        ...
        return exists != origExists ||
         ...
         /* Comment */        lastModified != origLastModified ||
...

    {
      ...
      /* Comment */   /* Comment */   return /* Comment */  /* Comment */  parent;
  ...
  /* Comment */        return parent ==  /* Comment */ null ? 0 : parent.getLevel() + 1;
     ...
     */
     ...
     /* Comment */ public FileEntry[] getChildren()
...

    {
         ...
         /* Comment */ this.children = children;
 ...
 /* Comment */ 
  ...
  /* Comment */    public void setLastModified(long lastModified)
 ...
 /* Comment */ 
    ...
    public void /* Comment */  setExists(boolean exists)
    ...
    public /* Comment */  boolean isDirectory()
