...

{
...

    {
        ...
        this(new File(directoryName), fileFilter); // EOL Comment
...

    {
...

        {
            ...
            listeners.add(listener); // EOL Comment
 // EOL Comment
        }
 ...
 // EOL Comment
        {
 // EOL Comment
            checkAndNotify(rootEntry, rootEntry.getChildren(), listFiles(rootFile)); // EOL Comment
 // EOL Comment
        }
        ...
        } // EOL Comment // EOL Comment // EOL Comment
 ...
 // EOL Comment
...

        {
            ...
            while (c < files.length && comparator.compare(entry.getFile(), files[c]) > 0) // EOL Comment
 ...
 // EOL Comment
...

            {
                ...
                checkAndNotify(entry, entry.getChildren(), FileUtils.EMPTY_FILE_ARRAY); // EOL Comment // EOL Comment
 ...
 // EOL Comment
...

    {
        ...
        StringBuilder builder = new StringBuilder(); // EOL Comment
