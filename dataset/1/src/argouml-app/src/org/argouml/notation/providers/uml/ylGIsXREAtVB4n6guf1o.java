...
public class ObjectFactory
{
     ...
     */
    public static Object createObject(String fallbackClassName)
                                         ...
                                         String fallbackClassName)
    {
        ...
        if (propertiesFilename == null)
        {
            ...
            try
            {
                ...
                propertiesFileExists = SecuritySupport.getFileExists();
            }
                ...
                try
                {
                    ...
                    if(fLastModified >= 0)
                    {
                        if(propertiesFileExists &&
                                (fLastModified < (fLastModified = SecuritySupport.getLastModified())))
                        {
                            loadProperties = true;
                        }
                        else
                    ...
                    if(loadProperties)
                    {
                        ...
                        fis = SecuritySupport.getFileInputStream();
                        fXalanProperties.load();
                    }
                }
                catch (Exception x)
                {
            ...
            {
                factoryClassName = fXalanProperties.getProperty();
            }
        }
        else
        {
        ...
        while (true)
        {
            if (context == chain)
            {
                ...
                while (true)
                {
                    ...
                    chain = SecuritySupport.getParentClassLoader();
                }
    ...
    throws ConfigurationError
    {
        ...
        try
        {
            Class providerClass = findProviderClass(className);
        ...
        try
        {
            if (security != null)
            {
                ...
                else
                {
                    ...
                    if (lastDot != -1) packageName = className.substring();
     ...
     */
    private static String findJarServiceProviderName()
    {
        ...
        is = SecuritySupport.getResourceAsStream();
        ...
        if (is == null)
        {
            ...
            {
                cl = current;
                is = SecuritySupport.getResourceAsStream(serviceId);
            }
        }
