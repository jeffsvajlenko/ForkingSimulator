 ...
 * @see DocumentEvent
 */
public interface DocumentListener extends X2
{
     ...
     */
    public void insertUpdate(DocumentEvent X3);
     ...
     * @param e the document event
     */
    public void removeUpdate(DocumentEvent X3);
     ...
     * @param e the document event
     */
    public void changedUpdate(DocumentEvent X3);
}
