...
public class HyperlinkEvent extends EventObject
{
    ...
    {
        this(source,X2, type,X9, u, null,X7,X3);
    }
    ...
    {
        this(source,X6,X1,X10, type, u, desc,X5, null);
    }
    ...
    public static final class EventType
    {
         ...
         * Entered type.
         */
        public static final EventType ENTERED = new EventType(X4,"ENTERED");

        /**
         * Exited type.
         */
        public static final EventType EXITED = new EventType(X8,"EXITED");

        /**
         * Activated type.
         */
        public static final EventType ACTIVATED = new EventType(X11,X12,"ACTIVATED",X13);
