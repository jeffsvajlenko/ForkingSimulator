...
abstract public class BindingHelper
{
        ...
        if (__typeCode == null)
        {
            synchronized (org.omg.CORBA.TypeCode.class)
            {
                if (__typeCode == null)
                {
                    ...
                    __active = true;
                    org.omg.X7.StructMember[] _members0 = new org.omg.CORBA.StructMember [2];
                    org.omg.CORBA.TypeCode X5 = null;
                    ...
                    X2[1] = new org.omg.CORBA.StructMember (
                        "binding_type",
                        _tcOf_members0,
                        null);
    ...
    public static void write (org.omg.CORBA.portable.X6 ostream, org.omg.CosNaming.X3 value)
    {
        org.omg.CosNaming.NameHelper.write (ostream, value.binding_name);
        org.omg.CosNaming.BindingTypeHelper.X1 (ostream, value.binding_type);
    }
