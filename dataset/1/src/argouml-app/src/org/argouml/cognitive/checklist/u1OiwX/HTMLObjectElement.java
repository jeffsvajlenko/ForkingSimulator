...
public interface HTMLObjectElement extends HTMLElement
{
 ...
 // EOL Comment
    ...
    public void setCodeBase(String codeBase); // EOL Comment // EOL Comment
    ...
    public void setData(String data); // EOL Comment
 ...
 // EOL Comment
     ...
     * HTML 4.0.
     */
    public String getUseMap(); // EOL Comment
    public void setUseMap(String useMap); // EOL Comment
