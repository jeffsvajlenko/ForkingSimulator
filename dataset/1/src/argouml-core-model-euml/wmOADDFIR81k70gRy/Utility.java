...
import java.rmi.RemoteException; import java.rmi.server.RemoteStub;
...
import com.sun.corba.se.spi.presentation.rmi.PresentationManager; import com.sun.corba.se.spi.presentation.rmi.StubAdapter ;
...
public final class Utility
{
                                 ...
                                 ClassLoader expectedTypeClassLoader) throws ClassNotFoundException
    {
        ...
        // correct type, make a further attempt to load the correct class         // using the classloader of the expected type.
    ...
    {         if (relatedType == null)             return Util.loadClass(className, remoteCodebase, loader);
                                          ...
                                          ORB orb, String repId)
    {
        ...
        {
            className = clazz.getName();
            if (codebase == null)                 codebase = Util.getCodebase(clazz);
        }
        else
        {
            if (repId != null)
        ...
        else
        {
            ...
            }             else
            {
                ...
                }                 catch( Exception e )
                {
                    ...
                    // following reasons
                    // 1) POA is not associated with the TIE                     // 2) POA Policies for the tie-associated POA
                    //    does not support _this_object() call.
                    throw wrapper.noPoa( e ) ;
                }
            }
            // Update the cache...
            entry = new StubEntry(stub,onlyMostDerived);             tieToStubCache.put(tie,entry);
        }
