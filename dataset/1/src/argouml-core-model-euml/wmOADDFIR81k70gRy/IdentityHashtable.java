...
public final class IdentityHashtable extends Dictionary
{
    ...
    public IdentityHashtable(int initialCapacity, float loadFactor)
    {
        ...
        {
  /* Comment */ /* Comment */             throw new IllegalArgumentException();
        }
        this.loadFactor = loadFactor;
        table = new IdentityHashtableEntry[initialCapacity];
        threshold = (int)(initialCapacity * loadFactor) /* Comment */ ;
    }
    ...
    {
        return new IdentityHashtableEnumerator(table, true /* Comment */ );
    }
    ...
    public boolean contains(Object value)
    {
        ...
        {
    /* Comment */          for (IdentityHashtableEntry e = tab[i] ; e != null ; e = e.next)
            {
                if (e.value == value)
            /* Comment */      {
      /* Comment */                return true;
     ...
     * @since   JDK1.0
     */
     /* Comment */ public /* Comment */  boolean containsKey(Object key)
    {
        IdentityHashtableEntry tab[] /* Comment */  = table;
        int hash = System.identityHashCode(key) /* Comment */ ;
         /* Comment */ int index = (hash & 0x7FFFFFFF) % tab.length;
   ...
   /* Comment */    /* Comment */     }
    ...
    {
        IdentityHashtableEntry tab[] = table;
        int /* Comment */  hash = System.identityHashCode(key);
        int index = (hash & 0x7FFFFFFF) % /* Comment */  tab.length;
    /* Comment */      for (IdentityHashtableEntry e = tab[index] ; e != null ; e = e.next)
        {
            if ((e.hash == hash) && e.key == key)
            {
                return e.value;
 ...
 /* Comment */    /* Comment */       table = newTable;
    ...
    /* Comment */      if (value == null)
        ...
        for (IdentityHashtableEntry e = tab[index] ; e != null ; e = e /* Comment */ .next)
        {
            if ((e.hash == hash) && e.key == key)
            {
                Object old = e.value;
          /* Comment */        e.value = value;
                return old;
            }
        }

 /* Comment */         if (count >= threshold)
        {
 ...
 /* Comment */         e.hash = hash;
    ...
    {
      /* Comment */    IdentityHashtableEntry tab[] = table;
        int hash = System.identityHashCode(key);
        int index = (hash & 0x7FFFFFFF) % tab.length;
        for (IdentityHashtableEntry e = tab[index], prev = null ; e != null ; prev = e, e = e. /* Comment */ next)
        {
            if ((e.hash == hash) && e.key == key)
            {
                if (prev != null)
