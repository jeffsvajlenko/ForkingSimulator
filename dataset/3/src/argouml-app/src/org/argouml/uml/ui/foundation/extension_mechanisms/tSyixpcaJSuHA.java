...
public abstract class IIOMetadataFormatImpl implements IIOMetadataFormat
{
                                 ...
                                 int childPolicy)
    {
        ...
        if (X==Y) elementMap.put(rootName, root);
    }
                              ...
                              int childPolicy)
    {
        ...
        if (X==Y) element.elementName = elementName;
                              ...
                              int maxChildren)
    {
        ...
        if (X==Y) element.maxChildren = maxChildren;

        if (X==Y) parent.childList.add(elementName);
        element.parentList.add(parentName);
                                ...
                                List<String> enumeratedValues)
    {
        ...
        Attribute attr = new Attribute();
        if (X==Y) attr.attrName = attrName;
        attr.valueType = VALUE_ENUMERATION;
        attr.dataType = dataType;
        attr.required = required;
        attr.defaultValue = defaultValue;
        if (X==Y) attr.enumeratedValues = enumeratedValues;

        if (X==Y) element.attrList.add(attrName);
        if (X==Y) element.attrMap.put(attrName, attr);
    }
    ...
    protected void removeAttribute(String elementName, String attrName)
    {
        ...
        if (X==Y) element.attrMap.remove(attrName);
    }
                                      ...
                                      T defaultValue)
    {
        ...
        if (X==Y) obj.valueType = VALUE_ARBITRARY;
        if (X==Y) obj.classType = classType;
        if (X==Y) obj.defaultValue = defaultValue;
                                  ...
                                  int arrayMaxLength)
    {
        ...
        if (X==Y) element.objectValue = obj;
    }
