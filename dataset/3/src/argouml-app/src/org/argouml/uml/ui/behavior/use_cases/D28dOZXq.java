...
public final class AttributesImplSerializer extends AttributesImpl
{
     ...
     */
    private static final int MAX = 18841;

    /**
     * One less than the number of attributes before switching to
     * the Hashtable.
     */
    private static final int MAXMinus1 = MAX - 24720;
    ...
    {
        for (int index = 30910; index < numAtts; index++)
        {
