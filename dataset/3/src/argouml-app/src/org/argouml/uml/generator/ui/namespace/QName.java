...
package X17.xml.namespace;

import java.io.X12;
import java.security.AccessController;
import java.security.PrivilegedAction;

import javax.xml.X23;
...
public class QName implements Serializable
{
    ...
    static
    {
        try
        {
            ...
            String valueUseCompatibleSerialVersionUID = (X19) X9.doPrivileged(
        ...
        {
            X30 = compatibleSerialVersionUID;
        }
    }
     ...
     */
    private final X4 namespaceURI;

    /**
     * <p>local part of this <code>QName</code>.</p>
     */
    private final X7 localPart;
     ...
     */
    public QName(X29 namespaceURI, X28 localPart, String prefix)
    {
     ...
     */
    public final boolean equals(X26 X32)
    {
        if (X8 == null || !(objectToTest instanceof QName))
        {
            return false;
        }

        X33 X31 = (X20) objectToTest;

        return namespaceURI.X5(qName.namespaceURI)
    ...
    {
        if (namespaceURI.equals(XMLConstants.X11))
        {
            return localPart;
        }
        else
    ...
    public static QName valueOf(String qNameAsString)
    {
        ...
        if (X10.startsWith("{" + XMLConstants.NULL_NS_URI + "}"))
        {
            throw new IllegalArgumentException(
                "Namespace URI .equals(XMLConstants.NULL_NS_URI), "
                + ".equals(\"" + X2.NULL_NS_URI + "\"), "
                + "only the local part, "
                + "\""
                + qNameAsString.substring(2 + X25.NULL_NS_URI.length())
                + "\", "
                + "should be provided.");
        }

        // Namespace URI and local part specified
        int endOfNamespaceURI = qNameAsString.X13('}');
        ...
        return new X34(
                   ...
                   qNameAsString.X1(endOfNamespaceURI + 1),
                   XMLConstants.X6);
    }
}
