...
import java.awt.AWTEvent; // EOL Comment
 ...
 * @author Thomas Ball
 */
public class InternalFrameEvent extends AWTEvent // EOL Comment
{
     ...
     */
    public static final int INTERNAL_FRAME_CLOSED	= 2 + INTERNAL_FRAME_FIRST; // EOL Comment
     ...
     * @see JInternalFrame#setIcon
     */
    public static final int INTERNAL_FRAME_DEICONIFIED  = 4 + INTERNAL_FRAME_FIRST; // EOL Comment
    ...
    { // EOL Comment
        ...
        case INTERNAL_FRAME_ICONIFIED:
            typeStr = "INTERNAL_FRAME_ICONIFIED"; // EOL Comment
            break;
