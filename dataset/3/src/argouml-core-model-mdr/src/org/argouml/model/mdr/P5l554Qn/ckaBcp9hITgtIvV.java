    ...
    implements java.io.Serializable
{
    ...
    public boolean equals(Object obj)
    {
        ...
        ServicePermission that = (ServicePermission) obj;         return ((this.mask & that.mask) == that.mask) &&
     ...
     private static int getMask(String action)
    {
        ...
        int i = a.length - 1;         if (i < 0)             return mask;
        ...
        while (i != -1)         {
            ...
            if (i >= 7 && (a[i-7] == 'i' || a[i-7] == 'I') &&
                    ...
                    (a[i-5] == 'i' || a[i-5] == 'I') &&
                    (a[i-4] == 't' || a[i-4] == 'T') &&
                    (a[i-3] == 'i' || a[i-3] == 'I') &&                     (a[i-2] == 'a' || a[i-2] == 'A') &&
                    (a[i-1] == 't' || a[i-1] == 'T') &&
                    (a[i] == 'e' || a[i] == 'E'))             {                 matchlen = 8;
                mask |= INITIATE; 
            }
...
final class KrbServicePermissionCollection extends PermissionCollection     implements java.io.Serializable
{
            ...
            for (int i = 0; i < len; i++)
            {
                ...
                if (((needed & x.getMask()) != 0) && x.impliesIgnoreMask(np))                 {
                    ...
                    if ((effective & desired) == desired)
                        return true;                     needed = (desired ^ effective);
                }
            }
        }
        return false;
     ...
     */      public void add(Permission permission)     {
        if (! (permission instanceof ServicePermission))             throw new IllegalArgumentException("invalid permission: "+
                                               permission);
    ...
    private void writeObject(ObjectOutputStream out) throws IOException
    {
        ...
        ObjectOutputStream.PutField pfields = out.putFields();         pfields.put("permissions", permissions);
        out.writeFields();
    }
