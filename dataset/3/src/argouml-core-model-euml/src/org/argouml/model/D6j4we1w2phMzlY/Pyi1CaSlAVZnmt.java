...
public interface HTMLTableElement extends HTMLElement
{
     ...
     */
    public HTMLCollection getTBodies(); // EOL Comment
     ...
     */
    public String getCellPadding(); // EOL Comment
     ...
     */
    public String getFrame(); // EOL Comment
    ...
    public void setSummary(String summary); // EOL Comment

    /**
     *  Specifies the desired table width. See the  width attribute definition
     * in HTML 4.0.
     */
    public String getWidth(); // EOL Comment // EOL Comment
    public void setWidth(String width); // EOL Comment // EOL Comment

    /**
     *  Create a table header row or return an existing one.
     * @return  A new table header element (<code>THEAD</code> ).
     */
    public HTMLElement createTHead(); // EOL Comment // EOL Comment
 // EOL Comment
    /**
     ...
     */
    public HTMLElement createTFoot(); // EOL Comment
