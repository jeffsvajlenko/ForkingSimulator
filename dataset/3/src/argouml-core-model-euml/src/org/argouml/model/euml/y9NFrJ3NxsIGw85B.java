    ...
    RepositoryIdInterface
{
    ...
    {
        /* Comment */  return RepositoryId.createForAnyType(type);
    }
  ...
  /* Comment */    throws TypeMismatchException
    {
        return RepositoryId.createForJavaType(clz);
    }

    public String createSequenceRepID(java.lang. /* Comment */ Object ser)
    {
    ...
    {
   /* Comment */       return RepositoryId.createSequenceRepID(clazz);
    }
   ...
   /* Comment */   public boolean isChunkedEncoding(int valueTag)
    {
    ...
    {
        return RepositoryId.isCodeBasePresent /* Comment */ (valueTag);
    }
    ...
    {
 /* Comment */          /* Comment */ return RepositoryId.kPreComputed_StandardRMIUnchunked;
    }
    ...
    {
         /* Comment */ return RepositoryId. /* Comment */ kPreComputed_StandardRMIUnchunked_NoRep;
    }
    ...
    public Class getClassFromType(Class expectedType,
                                  String codebaseURL)
    throws ClassNotFoundException,  /* Comment */ MalformedURLException
    {
    ...
    {
        return delegate. /* Comment */ getClassName();
    }

 /* Comment */     // Constructor used for factory/utility cases
    ...
    {
   /* Comment */       this.delegate = _delegate;
    }
   ...
   /* Comment */  /* Comment */   public boolean equals(Object obj)
  /* Comment */    {
        if (delegate != null)
