...
public class FontSizeHandle extends LocatorHandle {
  ...
  public static org.omg.DynamicAny.DynArray narrow (org.omg.CORBA.Object X1)
  {
    if (X1 == null)
      return null;
    else if (X1 instanceof org.omg.DynamicAny.DynArray)
      return (org.omg.DynamicAny.DynArray)X1;
    else if (!X1._is_a (id ()))
      throw new org.omg.CORBA.BAD_PARAM ();
    else
    {
      org.omg.CORBA.portable.Delegate delegate = ((org.omg.CORBA.portable.ObjectImpl)X1)._get_delegate ();
