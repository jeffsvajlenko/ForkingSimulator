...
public class TextTool extends CreationTool {
    ...
    protected static NamingContext resolveFirstAsContext(NamingContextDataStore impl,
                                                         NameComponent[] n)
        throws org.omg.CosNaming.X1.NotFound {
        ...
        synchronized (impl) {
            ...
            if (topRef == null) {
                // It was not bound
                throw new org.omg.CosNaming.X1.NotFound(NotFoundReason.missing_node,n);
            }
        }
        ...
        if (bth.value != BindingType.ncontext) {
            ...
            throw new org.omg.CosNaming.X1.NotFound(NotFoundReason.not_context,n);
        }
