...
abstract class AbstractFilter extends OutputStream
{
    ...
    protected  /* Comment */ boolean /* Comment */  specialsTable[];
    ...
    static
    {
        ...
        for (i = 0; i < 256; i++)
          /* Comment */    noSpecialsTable[i] = false;
 ...
 /* Comment */         int count;
        ...
        while(true) /* Comment */ 
        {
            ...
            {
             /* Comment */   /* Comment */    this.write(buf[i]);
            }
        }
    }
     ...
     * is a subclass.
     */
  /* Comment */    public void write(int b)
    throws IOException
    {
        if (b < 0)
     /* Comment */         b += 256;
        if (specialsTable[b])
      /* Comment */        writeSpecial(b);
        else
        {
    ...
    throws IOException /* Comment */ 
    {
        ...
        while (len > 0)
        {
            ...
            if (specialsTable[b])
            {
                if (accumulator != null)
                {
        /* Comment */              write( /* Comment */ accumulator.toString());
                    accumulator = null;
                }
                writeSpecial(b);
            }
            ...
            {
            /* Comment */      char ch = translationTable[b];
                if (ch != (char)0)
                {
                    if (accumulator == null)
     ...
     *          OutputStream.
     */
    public void /* Comment */  write(String s)
